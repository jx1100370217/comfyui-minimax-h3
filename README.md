> [!IMPORTANT]
> This repository packages a reproducible, general-purpose MiniMax H3 video workflow on top of ComfyUI. Start with the Chinese guide in [WORKFLOW2.md](WORKFLOW2.md). It intentionally excludes all project-specific scripts, character and voice references, generated canvases, render runs, finished videos, and model files.
