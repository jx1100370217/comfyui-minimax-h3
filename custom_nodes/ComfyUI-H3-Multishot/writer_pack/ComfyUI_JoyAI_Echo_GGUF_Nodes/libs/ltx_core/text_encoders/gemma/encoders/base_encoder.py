...
class GemmaTextEncoder(torch.nn.Module):
    ...
    def encode(
        ...
        # The model is built manually (not from_pretrained), so it starts in train mode;
        # transformers >=5.x Gemma3 then demands token_type_ids. Inference wants eval anyway.
